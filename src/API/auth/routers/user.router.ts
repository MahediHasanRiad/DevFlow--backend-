...
import { OTPrateLimit, passwordRateLimit } from "../../../middleware/rate-limit.middleware.js";
...
authRouter.post('/verify-opt', OTPrateLimit, VerifyOTPController)
authRouter.post('/reset-password', passwordRateLimit, authVerify, resetPasswordController)
