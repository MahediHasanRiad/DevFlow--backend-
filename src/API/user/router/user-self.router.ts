...
import { allUserListByTeamController } from "../controller/all-user-list.controller.js";
import { deleteAUserController } from "../controller/delete-user.controller.js";

const userSelfRouter = Router()

userSelfRouter.get('/list-of-all-users-by-team', allUserListByTeamController)
