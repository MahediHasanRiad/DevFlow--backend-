...
if (cluster.isPrimary) {
  ...
  // Initialize Worker Application Lifecycle
  async function startWorker() {
    try {
      // Connect to Redis once per worker process
      await connectRedis();
      
      // Initialize Socket.io and start listening
  ...
  // Gracefully disconnect Redis if the worker is killed
